# Seafarer welfare event fixtures (SYNTHETIC)

One canonical-wire envelope JSON per event type defined in
`proto/blueeconomy/contracts/v1/welfare.proto` and described in
...
```
kid:        blueeconomy-credential-verification-0
public key: r_2PSmU6m2LJ7aXLYoOjXzXY8S0IE6TiQmldezOs00M
```
